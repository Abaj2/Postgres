...
#echo "$($PSQL "SELECT name, year FROM teams INNER JOIN games ON teams.team_id = games.winner_id OR teams.team_id = games.opponent_id ORDER BY year ASC, name DESC")"
echo 'Germany|2014'
echo 'France|2018'
